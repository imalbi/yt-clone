...
{#if data && data.video && data.channel}
	<div class="flex w-full flex-col gap-2">
		...
		<h1 class="text-xl font-bold">{data.video.title}{videoData.snippet.title}</h1>
		<div class="flex flex-col justify-between md:flex-row">
			<div class="mt-2 flex flex-row gap-2">
				...
				<button
					class="h-fit cursor-pointer rounded-3xl bg-black px-4 py-2 align-middle font-semibold text-white"
					>Iscriviti</button
				>
			</div>
			...
			<div class="mr-10 flex h-12">
				<button
					class="flex h-full cursor-pointer items-center gap-2 rounded-l-full bg-gray-100 px-4 hover:bg-gray-300"
				>
					<svg
						class="h-6 w-6"
						...
						><defs
							><clipPath id="__lottie_element_736"
								><rect width="270" height="270" x="0" y="0"></rect></clipPath
							><clipPath id="__lottie_element_738"
								><path d="M0,0 L480,0 L480,480 L0,480z"></path></clipPath
							><clipPath id="__lottie_element_742"
								><path d="M0,0 L480,0 L480,480 L0,480z"></path></clipPath
							...
							><clipPath id="__lottie_element_803"
								><path d="M0,0 L480,0 L480,480 L0,480z"></path></clipPath
							></defs
						><g clip-path="url(#__lottie_element_736)"
							><g
								clip-path="url(#__lottie_element_738)"
								transform="matrix(0.4350000023841858,0,0,0.4350000023841858,28.474998474121094,26.724998474121094)"
								opacity="1"
								style="display: block;"
								><g clip-path="url(#__lottie_element_803)" style="display: none;"
									...
									><g style="display: none;"
										...
										></path></g
									></g
								><g clip-path="url(#__lottie_element_791)" style="display: none;"
									><g style="display: none;"
										><path stroke-linecap="round" stroke-linejoin="round" fill-opacity="0"
										></path></g
									><g style="display: none;"
										...
										></path></g
									></g
								><g clip-path="url(#__lottie_element_779)" style="display: none;"
									><g style="display: none;"
										><path stroke-linecap="round" stroke-linejoin="round" fill-opacity="0"
										></path></g
									><g style="display: none;"
								...
								><g clip-path="url(#__lottie_element_755)" style="display: none;"
									...
									></g
								><g
									clip-path="url(#__lottie_element_742)"
									transform="matrix(1,0,0,1,0,0)"
									opacity="1"
									style="display: block;"
									><g style="display: none;"><path></path><g><g></g></g></g><g
					...
					<span class="text-center text-nowrap"
						>{formatSubscriberCount(videoData.statistics.likeCount)}</span
					>
				</button>
				<button
					class="flex h-full cursor-pointer items-center rounded-r-full bg-gray-100 px-4 hover:bg-gray-300"
					aria-label="dislike"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
				...
				<button class="ml-3 cursor-pointer rounded-full bg-gray-100 px-3 py-1 hover:bg-gray-300">
					Condividi
				</button>
				<button class="ml-3 cursor-pointer rounded-full bg-gray-100 px-3 py-1 hover:bg-gray-300">
					Scarica
				...
				<button
					class="ml-3 hidden size-12 cursor-pointer rounded-full bg-gray-100 pb-4 text-2xl font-bold hover:bg-gray-300 md:block"
				>
					...
				</button>
			</div>
		</div>
		<div class="cursor-pointer rounded-2xl bg-gray-100 p-3">
			<h3>
				{formatSubscriberCount(videoData.statistics.viewCount)} visualizzazioni {formatData(
