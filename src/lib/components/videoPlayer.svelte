    ...
    <div class="flex flex-col gap-2 w-full">
        ...
        <div class="flex md:flex-row flex-col justify-between">
            ...
            <div class="mr-10 h-12 flex">
                <button class="bg-gray-200 hover:bg-gray-300 rounded-l-full cursor-pointer px-4 h-full flex items-center gap-2"> 
                ...
                <button class="bg-gray-200 hover:bg-gray-300 rounded-r-full cursor-pointer px-4 h-full flex items-center" aria-label="dislike">
                ...
                <button class="bg-gray-200 hover:bg-gray-300 rounded-full size-12 cursor-pointer ml-3 pb-4 font-bold text-2xl hidden md:block"> ... </button>
            </div>
        </div>
